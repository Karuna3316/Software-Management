...
public partial class ShiftTime : System.Web.UI.Page
{
    ...
    public static Changeshifttime_GsObj GetChangeshifttimeList()
    {
        try
        {
            return ChangeShifttimeDAL.GetshifttimeList();
        }
        catch (Exception ex)
        {

            Utilities.LogErrorToFile("Error in ShiftTime_GetChangeshifttimeList(): " + ex.Message);
            throw (ex);
        }
    }
    ...
    public static Changeshifttime_Gs BindShifttime(int Timeid)
    {
        ...
        {
            Utilities.LogErrorToFile("Error in ShiftTime_BindShifttime(): " + ex.Message);
            throw (ex);
        }
    }
    ...
    public static int SaveorUpdateShifttime(Changeshifttime_Gs Sfobj)
    {
        ...
        {
            Utilities.LogErrorToFile("Error in  ShiftTime_SaveorUpdateShifttime(): " + ex.Message);
            throw (ex);
        }
    }
    ...
    public static Changeshifttime_Gs BindChangeshifttimeEdit(int shiftchangeid)
    {
        ...
        {
            Utilities.LogErrorToFile("Error in  ShiftTime_BindChangeshifttimeEdit(): " + ex.Message);
            throw (ex);
        }
    }
    ...
    public static int DeleteChangeshifttime(int lReqId)
    {
        ...
        {
            Utilities.LogErrorToFile("Error in  ShiftTime_DeleteChangeshifttime(): " + ex.Message);
            throw (ex);
