<%@ Page Title="" Language="C#" MasterPageFile="~/YEEMAKHRMS.master" AutoEventWireup="true" CodeFile="EmployeeActiveReport.aspx.cs" Inherits="EmployeeActiveReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            GetEmployeeActiveReport();
        });

        function GetEmployeeActiveReport() {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "EmployeeActiveReport.aspx/GetEmployeeActiveReport",
                dataType: "json",
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Employee Active Report</li>
                    </ol>
                </nav>
            </div>
        </div>
