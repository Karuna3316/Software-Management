<%@ Page Title="" Language="C#" MasterPageFile="~/YEEMAKHRMS.master" AutoEventWireup="true" CodeFile="AttendanceLog.aspx.cs" Inherits="AttendanceLog" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function chkFrDates() {
            ...
            if (fD !== "" && eD !== "") {
                ...
                if (fD < eD) {
                    ...
                    $('#lblCr')[0].innerText = "";
                    BindAttendanceLog(fD, eD, Eid.val());
                } else {
        ...
        function BindAttendanceLog(stDate, EndDate, Employee) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "AttendanceLog.aspx/BindAttendanceLog",
                data: "{stD:'" + stDate + "',endD: '" + EndDate + "',Eid: '" + Employee + "'}",
                dataType: "json",
                success: function (data) {
                    formDocument().objAttLog().constructor();
        ...
        function BindEmployeeName(Value) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "AttendanceLog.aspx/BindEmployeeName",
                data: "{}",
                dataType: "json",
                success: function (data) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="form-group row g-3" style="padding-bottom: 10px;">
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" style="background: #fff !important;" placeholder="dd/mm/yyyy" id="dtFrom" autocomplete="off" readonly />
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="dtTo" style="background: #fff !important;" placeholder="dd/mm/yyyy" autocomplete="off" readonly />
                                <div class="input-group-addon">
                                    <i class=" fa fa-calendar" aria-hidden="true"></i>
                                </div>
                            </div>
            ...
            <div class="card-body">
                <div class="border p-3 rounded">
                    <div class="table-responsive">
                        <table id="basic-btn" class="table table-striped table-bordered" style="width: 100%" data-bind="visible: formDocument().objAttLog().length > 0">
                            <thead>
                                <tr role="row">
                                    <th>Employee ID</th>
                                    <th>Employee Name</th>
                            ...
                            <tbody data-bind="foreach: formDocument().objAttLog()">
                                <tr>
                                    ...
                                    <td style="text-align: center;"><span data-bind="text: CheckIn"></span></td>
                                    <td style="text-align: center;"><span data-bind="text: CheckOut"></span></td>
                                    <td style="text-align: center;"><span data-bind="text: BreakHours"></span></td>
                                    <td style="text-align: center;"><span data-bind="text: WorkingHour"></span></td>
                                    <td style="text-align: center;"><span data-bind="text: ExtraWorkingHour"></span></td>
                                </tr>
                            </tbody>
    ...
    <script type="text/javascript">
        var lstAttendanceLogObj = function () {

            this.objAttLog = ko.observableArray([{
                EmployeeID: '', EmployeeName: '', Designation: '', Date: '', ShiftType: '', CheckIn: '', CheckOut: '', WorkingHour: '', BreakHours: '', ExtraWorkingHour: ''
            }]);
        };
        formDocument = ko.observable(new lstAttendanceLogObj());
        ko.applyBindings(new lstAttendanceLogObj(), document.getElementById("basic-btn"));
    </script>
</asp:Content>
